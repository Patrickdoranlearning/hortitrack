-- Batch search view consolidating denormalized fields for UI queries and offline sync.
drop view if exists public.v_batch_search;

create view public.v_batch_search as
select
  b.id,
  b.org_id,
  b.batch_number,
