-- Create perform_transplant function for atomic batch transplants
-- This function handles: creating child batch, decrementing parent, linking ancestry, logging events, and creating passport
...
BEGIN
  ...
  -- Archive parent if empty and requested
...
GRANT EXECUTE ON FUNCTION public.perform_transplant TO authenticated;

COMMENT ON FUNCTION public.perform_transplant IS
  'Atomically performs a batch transplant: creates child batch, decrements parent quantity,
