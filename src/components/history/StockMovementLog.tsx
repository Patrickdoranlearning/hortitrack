...
const TYPE_META: Record<string, {
  ...
  check_in: { label: "Check In", variant: "default", icon: 'in' },
  ...
  move_in: { label: "Moved In", variant: "default", icon: 'in' },
  propagate: { label: "Propagated", variant: "default", icon: 'in' },
  stock_received: { label: "Received", variant: "default", icon: 'in' },
  batch_actualized: { label: "Actualized", variant: "default", icon: 'in' },
  actualized: { label: "Actualized", variant: "default", icon: 'in' },
  ...
  move: { label: "Moved Out", variant: "secondary", icon: 'out' },
  consumed: { label: "Consumed", variant: "secondary", icon: 'out' },
